            ...
            <div className="mx-auto  flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
                ...
                >
                    <AnimatedWords
                        title={"contact"}
                        style={
                            "text-[50px] md:text-[200px] flex max-w-[400px] flex-col items-start text-left  font-extrabold uppercase  text-[#e4ded7] sm:max-w-full sm:flex-row sm:items-center sm:justify-center sm:text-center md:text-[150px] lg:text-center "
                        }
                    />
                </div>
